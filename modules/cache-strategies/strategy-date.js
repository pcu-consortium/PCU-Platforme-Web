/**
 * Created by gpotdevin on 16/06/2015.
 */
var fs = require("fs"),
    hash = require("static-asset/lib/hash"),
    cache = {}, //filename => {"mtime": dateObject, "etag": string, "size": fileSize}
    cacheOn = process.env.NODE_ENV == "preproduction" || process.env.NODE_ENV == "production" || process.env.NODE_ENV == "prod";

define("ace/mode/wml_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
...
}), define("ace/mode/wml", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/wml_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/coffee"], function(e, t, n) {
    "use strict";
    var CstyleBehaviour = e("./behaviour/cstyle").CstyleBehaviour;
    var r = e("../lib/oop"),
        i = e("./text").Mode,
        s = e("./wml_highlight_rules").YamlHighlightRules,
        o = e("./matching_brace_outdent").MatchingBraceOutdent,
        u = e("./folding/coffee").FoldMode,
        a = function() {
            this.HighlightRules = s, this.$outdent = new o, this.foldingRules = new u, this.$behaviour = new CstyleBehaviour();
        };
    r.inherits(a, i),
        function() {
